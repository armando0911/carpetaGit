...
SECRET_KEY = 'django-insecure-(-e&ia%bu&x^_u)dp7+vl((#szt2h@lk_kwd1&plkx5b#-vl49'
...
CKEDITOR_CONFIGS ={
    'default':{'toolbar':'Custom',
        'toolbar_Custom':[
            ...
            ['NumberedList','BulletedList','-','Outdent','Indent','-', 'JustifyLeft','JustifyCenter,JustifyRigth','JustifyBlock'],
            ['link','UnLink'],
            ['RemoveFormat','Source']
        ]
    }
